  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex w-full border-2 mb-2 rounded-2xl border-black p-3 items-center justify-between"
      >
        <img
          className="h-14"
      ...
      <div
        ...
        className="flex w-full border-2 mb-2 rounded-2xl active:border-black p-3 items-center justify-between"
      >
        <img
          className="h-14"
